...
void inference_viewer::saveHTML(QString fileName, bool exportTool)
{
    ...
    if(fileName.size() > 0) {
        ...
        if(fileObj.open(QIODevice::WriteOnly)) {
            ...
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><font color=\"black\" size=\"4\"><b>Total Images</b> sent for Inference</font></td>\n");
            text.sprintf("\t<td align=\"center\"><font color=\"black\" size=\"4\"><b>%d</b></font></td>\n",state->imageDataSize);
            fileObj.write(text.toStdString().c_str());
            fileObj.write("\t</tr>\n");
            fileObj.write("\t</table>\n<br><br><br>\n");
            ...
            fileObj.write(text.toStdString().c_str());
            fileObj.write("\t<td><font color=\"black\" size=\"4\">Inference<b>Mismatch Percentage</b></font></td>\n");
            accuracyPer = ((float)state->totalMismatch/netSummaryImages);
            text.sprintf("\t <td align=\"center\"><font color=\"black\" size=\"4\"><b>%.2f</b></font></td>\n",(accuracyPer*100));
            fileObj.write(text.toStdString().c_str());
            fileObj.write("\t</tr>\n<tr>\n");
            ...
            // Image result
            fileObj.write("<A NAME=\"table1\"><h1 align=\"center\"><font color=\"DodgerBlue\" size=\"6\"><br><em>Image Results</em></font></h1></A>\n");
            ...
            fileObj.write("\t\t<td align=\"center\"><font color=\"Maroon\"><b>Prob-5</b></font></td>\n");
            fileObj.write("\t\t</tr>\n");
            for(int i = 0; i < state->imageDataSize; i++) {
                fileObj.write("\t\t<tr>\n");
                int truth = state->imageLabel[i];
