...
void inference_viewer::saveHTML(QString fileName, bool exportTool)
{
    ...
    if(fileName.size() > 0) {
        ...
        if(fileObj.open(QIODevice::WriteOnly)) {
            ...
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><H2>List of Features Available in this release</H2></td>\n");
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><H2>Overall Summary</H2></td>\n");
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><H2>Graphs</H2></td>\n");
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><H2>Hierarchy</H4></td>\n");
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><H2>Labels</H2></td>\n");
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><H2>Image Results</H2></td>\n");
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
            fileObj.write("\t<td><H2>Compare</H2></td>\n");
            fileObj.write("\t</tr>\n");
            fileObj.write("\t<tr>\n");
